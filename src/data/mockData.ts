...
export const mockMaintenanceJobs: MaintenanceJob[] = [
  ...
  },
  {
    ...
    depot: 'C',
    priority: 'urgent',
    description: 'Safety system check',
    assigned_crew: 'Crew-C1',
  },
  {
    id: 'M04',
    train_id: 'T09',
  ...
  },
  {
    ...
    depot: 'C',
    priority: 'medium',
    description: 'Interior refurbishment',
    assigned_crew: 'Crew-C2',
...
export const mockAlerts: Alert[] = [
  {
    ...
    message: 'Fitness certificate expired - immediate attention required',
    resolved: false,
  },
  {
    id: 'A02',
  ...
  },
  {
    ...
    message: 'Fitness score below threshold',
    resolved: true,
    resolved_by: 'supervisor1',
    resolved_at: '2025-09-18T20:00:00Z',
  },
  {
    id: 'A04',
    train_id: 'T19',
    ...
    message: 'Critical maintenance overdue',
    resolved: false,
  },
];
...
export const mockBrandingCampaigns: BrandingCampaign[] = [
  {
    id: 'BC01',
    name: 'AdCampaign1',
    description: 'Tourism promotion campaign',
    priority: 8,
    start_date: '2025-09-01',
    end_date: '2025-12-31',
    target_trains: ['T01', 'T03', 'T09', 'T15', 'T20', 'T24'],
    status: 'active',
  ...
  },
  {
    id: 'BC02',
    name: 'AdCampaign2',
    description: 'Corporate partnership branding',
    priority: 6,
    start_date: '2025-08-15',
    end_date: '2025-11-30',
    target_trains: ['T02', 'T07', 'T12', 'T16', 'T18', 'T21', 'T25'],
    status: 'active',
  ...
  },
  {
    id: 'BC03',
    name: 'AdCampaign3',
    description: 'Safety awareness campaign',
    priority: 9,
    start_date: '2025-09-10',
    end_date: '2025-10-31',
    target_trains: ['T05', 'T11', 'T17', 'T23'],
    status: 'active',
...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    name: 'Priya Nair',
    depot_access: ['A'],
    permissions: ['view_depot', 'view_reports'],
  },
  {
    id: 'U03',
    username: 'admin1',
